...
src_install() {
	...
	newins httpcore/target/httpcore-${PV}.jar httpcore.jar || die "failed to install httpcore"
	newins httpcore-nio/target/httpcore-nio-${PV}.jar httpcore-nio.jar || die "failed to install httpcore-nio"
}
