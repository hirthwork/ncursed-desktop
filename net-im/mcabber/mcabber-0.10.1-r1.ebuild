...
# $Header: /var/cvsroot/gentoo-x86/net-im/mcabber/mcabber-0.10.1-r1.ebuild,v 1.1 2012/03/15 15:23:33 wschlich Exp $
...
IUSE="aspell crypt idn modules otr spell ssl unordered-completion vim-syntax"
...
src_prepare() {
	use unordered-completion && epatch "${FILESDIR}"/unordered-completion.patch
}
